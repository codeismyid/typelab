declare module 'conventional-changelog-conventionalcommits' {
  ...
  /**
   * @param config - Based on {@link https://github.com/conventional-changelog/conventional-changelog-config-spec/tree/master/versions/2.2.0 conventional-changelog-config-spec-2.2.0} & {@link https://github.com/conventional-changelog/conventional-changelog/tree/conventional-changelog-conventionalcommits-v9.1.0 conventional-changelog-conventionalcommits-v9.1.0}.
   * @return `Object` based on {@link https://github.com/conventional-changelog/conventional-changelog/tree/conventional-changelog-conventionalcommits-v9.1.0 conventional-changelog-conventionalcommits-v9.1.0}.
   */
